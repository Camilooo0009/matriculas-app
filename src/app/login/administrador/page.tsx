    ...
    <main className="p-6">
      <div className="max-w-xl mx-auto bg-white/70 backdrop-blur rounded-3xl p-6 shadow-sm border">
        <div className="flex flex-col items-center text-center">
          <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white text-2xl">👤</div>
          <h1 className="mt-3 text-2xl font-bold text-indigo-700">Acceso de Administrador</h1>
        </div>
        ...
        <div className="mt-6">
          <button
            ...
            className="mt-3 w-full rounded-2xl border border-indigo-600 text-indigo-700 py-3 font-semibold hover:bg-indigo-50"
          >
            ...
            <form
              onSubmit={(e) => {
                ...
                try {
                  ...
                  writeUsers(users);
                  localStorage.setItem("admin_demo_user", fullName.trim());
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              ...
              <button
                type="submit"
                disabled={saving}
                className="w-full rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 font-semibold hover:opacity-95 disabled:opacity-60"
              >
            ...
            <form
              onSubmit={(e) => {
                ...
                try {
                  ...
                  localStorage.setItem("admin_demo_user", u.fullName);
                  window.location.href = "/admin";
                } catch {
